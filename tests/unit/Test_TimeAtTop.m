    ...
    methods(Test)
        ...
        function testModelUsingGncTime(testcase)  
            ...
            patterns(1).ContainsOrderedStrings = { ...
                'void GncTimeAtTop_step(void)', ...
                '{', ...
                'GncTimeAtTop_Y.Out1 = ((real_T)ECI_TimeStamp.Seconds + ((real_T)', ...
                'ECI_TimeStamp.Subseconds/4294967296.0));', ...
                'GncTimeAtTop_AtomicSubsystem(&GncTimeAtTop_Y.Out2);', ...
                '}'   };
        ...
        function testSubsystemUsingGncTime(testcase)             
            ...
            patterns(1).ContainsOrderedStrings = { ...
                'void GncTimeAtTop_AtomicSubsystem(real_T *rty_Out1)', ...
                '{', ...
                '(*rty_Out1) = ((real_T)ECI_TimeStamp.Seconds + ((real_T)', ...
                'ECI_TimeStamp.Subseconds/4294967296.0));', ...
                '}'   };                                       
